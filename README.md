...
<div class="container hidden" id="page3">
  ...
  <button class="yes-btn" onclick="nextPage4()">Yes</button>
  <button class="yes-btn" onclick="nextPage4()">Aama</button>
  <button class="yes-btn" onclick="nextPage4()">Avunu</button>
</div>
...
/* Show page 4 with fade-out effect on page 3 buttons and rose petals */
function nextPage4(){
  const page3 = document.getElementById("page3");
  const buttons = page3.querySelectorAll("button");
  ...
  // After fade, hide page3 and show page4
  setTimeout(()=>{
